...
def client_program():
    ...
    while True:
        ...
        plaintext = decrypt(key=key, ciphertext=raw)
        print('Server: ', raw)
        print("Decrypted: ", plaintext)

        data = input('Client: ')
        cipher = encrypt(key=key, plaintext=data)
        print("This is encrypted: ", cipher)
        client_socket.send(cipher) # send data to the client
